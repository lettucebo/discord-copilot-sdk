...
const MESSAGES = {
  zh: {
    ...
    residencyPrompt: "是否設定 24/7 常駐（登入後自動啟動並保持存活）？[y/N]",
    residencyWin: "已註冊 Windows 排程工作：",
  ...
  en: {
    ...
    residencyPrompt: "Set up 24/7 residency (auto-start + keepalive while logged in)? [y/N]",
    residencyWin: "Registered Windows Scheduled Task: ",

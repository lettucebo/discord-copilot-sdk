...
const MESSAGES = {
  zh: {
    ...
    updateIncompleteRestartLabel: "自動復原",
    ...
    updatePendingRestore: "警告：上一次更新仍等待 --restore；自動復原未完成。",
    ...
    updateFailed: "更新未完成；自動復原未完成。修正原因後執行 node scripts/update.mjs --restore。",
    yes: "是",
    no: "否",
  ...
  en: {
    ...
    updateIncompleteRestartLabel: "Automatic recovery",
    ...
    updatePendingRestore: "Warning: a failed update still awaits --restore; automatic recovery did not complete.",
    ...
    updateFailed: "Update did not complete; automatic recovery did not complete. Fix the cause, then run node scripts/update.mjs --restore.",
    yes: "yes",
    no: "no",

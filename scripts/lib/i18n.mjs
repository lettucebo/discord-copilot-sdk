...
const MESSAGES = {
  zh: {
    ...
    updatePendingRestore: "警告：先前的更新留下了復原記錄；請執行 node scripts/update.mjs --restore。",
    ...
    updateFailed: "更新未完成；更新收尾未完成。修正原因後執行 node scripts/update.mjs --restore。",
    yes: "是",
    no: "否",
  ...
  en: {
    ...
    updatePendingRestore: "Warning: a previous update left a recovery record; run node scripts/update.mjs --restore.",
    ...
    updateFailed: "Update did not complete; update finalization did not complete. Fix the cause, then run node scripts/update.mjs --restore.",
    yes: "yes",
    no: "no",

...
const MESSAGES = {
  zh: {
    ...
    planHeader: "安裝計畫",
    planPackageVersion: "套件版本",
    planRepositoryRoot: "Repository 根目錄",
    planEnvPath: ".env 路徑",
    planStateDir: "狀態目錄",
    planInstanceId: "執行個體 id",
    planDryRun: "模擬執行",
    notInRepo: "請在 discord-copilot-sdk 專案根目錄執行（找不到 name=discord-copilot-sdk 的 package.json）。請先 clone 再執行。",
    prereqHeader: "檢查前置需求…",
    stagePrereqs: "前置需求與 Copilot 登入狀態",
    stageConfig: "收集設定",
    stageBuild: "安裝相依套件與建置",
    stageValidateWrite: "設定驗證與 .env 寫入",
    stageResidency: "常駐設定",
    prereqNodeLabel: "Node",
    prereqGitLabel: "Git",
    prereqCopilotLabel: "Copilot",
    prereqAuthLabel: "登入狀態",
    prereqPresentPath: "已在 PATH 上",
    prereqMissingValue: "缺少",
    authStateSkipped: "未驗證（已略過 --skip-auth）",
    authStateUnauthenticated: "未登入",
    authStateIndeterminate: "無法確認",
    ...
    buildStepStarting: "執行 {0}…",
    buildStepDone: "{0} 完成（耗時 {1}）。",
    buildStepFailed: "{0} 失敗（耗時 {1}）。",
    buildLogPath: "完整記錄（僅限本人）：{0}",
    buildRecentLogTail: "最近 {0} 行輸出：",
    buildLogDirError: "無法建立或保護安裝記錄目錄：{0}",
    buildLogFileError: "無法建立或保護安裝記錄檔：{0}",
    buildStartFailed: "無法啟動 {0}：{1}",
    buildSignalFailed: "{0} 異常結束（{1}）。",
    healthOk: "設定載入健檢通過。",
    ...
    configPreviewHeader: "將寫入的設定（token 已遮蔽）",
    doneHeader: "✅ 安裝完成",
    summaryHeader: "操作摘要",
    summaryResidencyLogLabel: "常駐記錄",
    summaryManualLabel: "最後一步",
    summarySafetyLabel: "安全提醒",
    doneVersion: "版本：",
    doneStart: "啟動：",
    doneStop: "停止：",
    doneLog: "查看記錄：",
    ...
    updateStatusHeader: "更新狀態",
    updateStatusCurrentVersion: "目前版本",
    updateStatusRepositoryRoot: "Repository 根目錄",
    updateStatusCheckout: "Checkout",
    updateStatusRequestedRef: "要求的 ref",
    updateStatusInstance: "執行個體",
    updatePlanHeader: "更新計畫",
    updatePlanCurrentVersion: "目前版本",
    updatePlanTargetVersion: "目標版本",
    updatePlanTargetInstances: "目標執行個體",
    updatePlanInstanceState: "執行個體狀態",
    updateDryRunHeader: "Dry-run 計畫",
    updateDryRunFetch: "會在真正更新時才 fetch origin {0}。",
    updateDryRunApply: "會停止所選常駐／bot 行程、移動 HEAD、執行 setup，然後還原原本的執行狀態。",
    updateDryRunLimitations: "目標版本與 release notes 只會在真正更新的 fetch 後得知。",
    updateRestoreStatusHeader: "還原狀態",
    updateRestoreStatusSavedInstance: "儲存的執行個體",
    updateRestoreStatusRepositoryRoot: "記錄的 root",
    updateRestoreStatusSavedSource: "記錄的原始碼",
    updateRestoreStatusCreatedAt: "建立時間",
    updateRestoreStatusCurrentVersion: "目前版本",
    updateIncompleteHeader: "更新未完成",
    updateIncompleteRestartLabel: "更新收尾",
    updateIncompleteRestart: "未完成",
    updateIncompleteRecoveryLabel: "復原指令",
    updateInstanceStatus: "{0}: {1}、{2}",
    updateRunning: "執行中",
    updateStoppedState: "已停止",
    updateResidencyEnabled: "常駐已啟用",
    updateResidencyDisabledState: "常駐已停用",
    updateResidencyNotRegisteredState: "未註冊常駐",
    updateResidencyUnknownState: "常駐狀態未知",
    updateAlreadyCurrent: "已是最新版本：{0} ({1})。",
    updatePendingRestore: "警告：先前的更新留下了復原記錄；請執行 {0}。",
    updateAvailable: "有可用更新：{0} ({1}) -> {2} ({3})。",
    updateApplyHint: "套用更新：{0}",
    updateTargetNotes: "{0} 版更新摘要：",
    updateTargetNotesOmitted: "…另省略 {0} 行非空白內容。",
    updateCompareLink: "完整差異：{0}",
    updateStageStop: "停止",
    updateStageSource: "套用原始碼",
    updateStageSetup: "執行 setup",
    updateStageRestore: "還原執行狀態",
    ...
    updateDryRun: "這只是 dry run；不會變更任何檔案或系統狀態。",
    ...
    updateFailed: "更新未完成；更新收尾未完成。修正原因後執行 {0}。",
    updatePrivateRefCleanupFailed: "警告：無法刪除私有更新 ref {0}；請手動移除。",
    yes: "是",
    no: "否",
  ...
  en: {
    ...
    planHeader: "Install plan",
    planPackageVersion: "Package version",
    planRepositoryRoot: "Repository root",
    planEnvPath: ".env path",
    planStateDir: "State directory",
    ...
    stagePrereqs: "Prerequisites and Copilot sign-in state",
    stageConfig: "Configuration collection",
    stageBuild: "Dependency install and build",
    stageValidateWrite: "Config validation and .env write",
    stageResidency: "Residency setup",
    prereqNodeLabel: "Node",
    prereqGitLabel: "Git",
    prereqCopilotLabel: "Copilot",
    prereqAuthLabel: "Sign-in state",
    prereqPresentPath: "present on PATH",
    prereqMissingValue: "missing",
    authStateSkipped: "unverified (skipped --skip-auth)",
    authStateUnauthenticated: "unauthenticated",
    authStateIndeterminate: "indeterminate",
    ...
    buildStepStarting: "Running {0}…",
    buildStepDone: "{0} completed ({1}).",
    buildStepFailed: "{0} failed ({1}).",
    buildLogPath: "Full log (owner-only): {0}",
    buildRecentLogTail: "Recent output (last {0} lines):",
    buildLogDirError: "Could not create or secure the setup log directory: {0}",
    buildLogFileError: "Could not create or secure the setup log file: {0}",
    buildStartFailed: "Could not start {0}: {1}",
    buildSignalFailed: "{0} terminated unexpectedly ({1}).",
    ...
    configPreviewHeader: "Config to write (token masked)",
    doneHeader: "✅ Installation complete",
    summaryHeader: "Action summary",
    summaryResidencyLogLabel: "Residency log",
    summaryManualLabel: "Manual next step",
    summarySafetyLabel: "Safety warning",
    ...
    updateCheckout: "  checkout {0} ({1})",
    updateRequested: "  requested {0} -> {1} @ {2}",
    updateStatusHeader: "Update status",
    updateStatusCurrentVersion: "Current version",
    updateStatusRepositoryRoot: "Repository root",
    updateStatusCheckout: "Checkout",
    updateStatusRequestedRef: "Requested ref",
    updateStatusInstance: "Instance",
    updatePlanHeader: "Update plan",
    updatePlanCurrentVersion: "Current version",
    updatePlanTargetVersion: "Target version",
    updatePlanTargetInstances: "Target instances",
    updatePlanInstanceState: "Instance state",
    updateDryRunHeader: "Dry-run plan",
    updateDryRunFetch: "Would fetch origin {0} only during a real update.",
    updateDryRunApply:
      "Would stop the selected residency/bot processes, move HEAD, run setup, then restore the prior running state.",
    updateDryRunLimitations: "Target version and release notes will be discovered only during a real update fetch.",
    updateRestoreStatusHeader: "Restore status",
    updateRestoreStatusSavedInstance: "Saved instance",
    updateRestoreStatusRepositoryRoot: "Recorded root",
    updateRestoreStatusSavedSource: "Saved source",
    updateRestoreStatusCreatedAt: "Created at",
    updateRestoreStatusCurrentVersion: "Current version",
    updateIncompleteHeader: "Update incomplete",
    updateIncompleteRestartLabel: "Update finalization",
    updateIncompleteRestart: "did not complete",
    updateIncompleteRecoveryLabel: "Recovery command",
    updateInstanceStatus: "{0}: {1}, {2}",
    updateRunning: "running",
    updateStoppedState: "stopped",
    updateResidencyEnabled: "residency enabled",
    updateResidencyDisabledState: "residency disabled",
    updateResidencyNotRegisteredState: "residency not registered",
    updateResidencyUnknownState: "residency unknown",
    updateAlreadyCurrent: "Already up to date: {0} ({1}).",
    updatePendingRestore: "Warning: a previous update left a recovery record; run {0}.",
    updateAvailable: "Update available: {0} ({1}) -> {2} ({3}).",
    updateApplyHint: "Apply it with: {0}",
    updateTargetNotes: "Target release notes for {0}:",
    updateTargetNotesOmitted: "... {0} more non-empty line(s) omitted.",
    updateCompareLink: "Full diff: {0}",
    updateStageStop: "Stop",
    updateStageSource: "Apply source",
    updateStageSetup: "Run setup",
    updateStageRestore: "Restore running state",
    ...
    updateDryRun: "Dry run only; no files or system state were changed.",
    ...
    updateFailed: "Update did not complete; update finalization did not complete. Fix the cause, then run {0}.",
    updatePrivateRefCleanupFailed: "Warning: private update ref {0} could not be removed; remove it manually.",
    yes: "yes",
    no: "no",

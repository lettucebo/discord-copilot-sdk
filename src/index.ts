...
import { publishStartupReady, startupReadyRequest, clearStartupReady } from "./core/startup-ready.js";
...
async function main(): Promise<void> {
  ...
  await startBot({
    ...
    // leave a marker claiming this pid is serving.
    retractReady: () => clearStartupReady(),
  });
